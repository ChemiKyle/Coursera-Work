...
figure;
plot(1:numel(J1), J1, '-c', 'LineWidth', 2);
...
plot(1:numel(J4), J4, '-r', 'LineWidth', 2);
plot(1:numel(J5), J5, '-k', 'LineWidth', 2);

xlabel('Number of iterations');
ylabel('Cost J');
legend('\alpha = 0.01', '\alpha = 0.03', '\alpha = 0.1', '\alpha = 0.3', '\alpha = 1');
title('Convergence and learning rates for  3D data')
