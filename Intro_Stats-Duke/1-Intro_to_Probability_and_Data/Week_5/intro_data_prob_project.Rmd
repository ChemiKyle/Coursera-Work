...
Now we see a multimodal ditribution clustured around multiples of 5, the mode of which is 30.
...
Taking into account the multimodality of the data, there appears to be a right skew when one does not consider individuals for whom every day has been one of poor mental health (these people likely suffer from a depressive disorder, let's quickly check on that).
